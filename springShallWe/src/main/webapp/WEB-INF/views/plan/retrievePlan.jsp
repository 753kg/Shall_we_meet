...
<!-- 본문 시작 --> 
   ...
   <script type="text/javascript">
      ...
      function toMakePlanPage(){
         location.href = "makeplan.do";
      }
      
     
      function goToSelectLocationbyMember(planid) {
         location.href ="departure.do?plan_id=" + planid;
      }
      function goToCalculator(planid) {
         location.href = "midpoint.do?plan_id="+planid;
      }
      function goToSelectDatebyMember(planid) {
         location.href ="selectDate.do?plan_id="+planid;
      }
      function goToFixDate(planid) {
         location.href ="fixDate.do?plan_id="+planid;
      }
