...
<style>
body{
background-image: url('${cpath }/frontDesign/imageSource/배경1.png');
...
<body>
	...
	<section>
   <div class="content25">
   <img src="${cpath }/frontDesign/imageSource/출발지를입력해주세요.png" id="text-image25" style="height: 125px; width:auto; left:630px;">     
	<form id="makePlanForm" class="form-group" action="departure.do" method="post">  
		...
		<div>
			...
			<input type="hidden" id="member_lat" name="lat" value="">
			<input type="hidden" id="member_lon" name="lon" value="">
		</div>
