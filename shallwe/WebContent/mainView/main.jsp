...
<body>
	...
	<div class="wrap">
		...
		<div class="reg">
		    	<p class="mb-0"><a href="../login/Register" class="mr-2">Sign Up</a> 
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown04">
              	<a class="dropdown-item" id="dropdown-menu25" href="../makeplan/Makeplan" >새 약속 만들기</a>
    ...
    <source src="/shallwe/frontDesign/imageSource/background.mov">
  </video>
	<div style="display: relative;">
		
		<img id="maintext" src="../frontDesign/imageSource/우리 한 번 봐야지.png">
		<img id="subtext" src="../frontDesign/imageSource/메인 문구.png">
		<button class="new-plan-btn" type="button" style="vertical-align:middle" onclick="location.href='../makeplan/Makeplan'" ><span>약속 만들기 </span></button>
    			...
    			<div class="col-md-4 d-flex">
    				<div class="intro d-lg-flex w-100 ftco-animate">
    					...
    					<div class="text">
							...
							<p>frontDesign/css/animate.css</p>		
